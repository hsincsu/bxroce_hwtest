...
static int mac_hw_init(struct mac_pdata *pdata)
{
    ...
    //mac_bandwidth_alloc(&pdata->rnic_pdata,0);
		...
		regval = 0x00602000;//before: 0x00002000; //to channel 6;
		...
		regval = 0x00000001;
		writel(regval, pdata->mac_regs + 0x24);
		...
		regval = 0x00602010;// before: 0x00c02010;
		writel(regval, pdata->mac_regs + 0x164);

		regval = 0x03020180;
		writel(regval, pdata->mac_regs + 0x1030);
		
		regval = 0x07808004;// before: 0x07068004;
